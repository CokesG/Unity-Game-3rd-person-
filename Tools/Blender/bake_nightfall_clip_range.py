...
def main():
    if "--" not in sys.argv:
        raise SystemExit(
            "Usage: blender -b --python bake_nightfall_clip_range.py -- source.glb target_model.fbx out.fbx clip_name frame_start frame_end"
        )
    ...
    for target_pose_bone in target_armature.pose.bones:
        ...
        constraint.name = "BakeFromSourceRange"
