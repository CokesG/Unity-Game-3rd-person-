...
9 Crouched Walk
0 Crouch -> Stand
Q/E Cycle authored crouch-walk direction while 9 is active
```
...
```text
Tools/TPS/Nightfall/Reimport Crouch Walk Candidates
```

`9 Crouched Walk` is the authored directional crouch-walk review lane. The set must stay low, grounded, readable from front and side, and consistent across forward/back/left/right before any live `SampleScene` promotion.
