...
- Current slide-to-crouch stability tuning: `slideGroundStickForce` is `8`, `slideExitSpeedCarry` is `1.1`, `slideStartGroundedStableTime` is `0.06`, and `slideCrouchExitGroundStickTime` is `0.18`.
