...
- Current slide-to-crouch stability tuning: `slideGroundStickForce` is `8`, `slideExitSpeedCarry` is `1.1`, `slideStartGroundedStableTime` is `0.06`, `slideCrouchExitGroundStickTime` is `0.18`, `slideExitJumpLockTime` is `0.2`, and `slideExitStandLockTime` is `0.18`.
